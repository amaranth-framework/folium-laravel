    ...
    class ValidatedTest extends \Itmcdev\Folium\Tests\Laravel\Crud\SimpleTest
    {
        ...
        public function setUp()
        {
            ...
            $container
                ...
                ->addArgument(
                    \Itmcdev\Folium\Operation\Eloquent\Crud\Create::class
                )
                ->addArgument(
                    \Itmcdev\Folium\Tests\Laravel\Model\Validated::class
                );
                ...
                $container
                    ->add(
                        str_replace(
                            'Create',
                            $operation,
                            \Itmcdev\Folium\Operation\Eloquent\Crud\Create
                                ::class
                        )
                    )
                    ->addArgument(
            ...
            $this->controller = $container->get(
                \Itmcdev\Folium\Tests\Laravel\Crud\Controller::class
            );
        }
    }
} else {
